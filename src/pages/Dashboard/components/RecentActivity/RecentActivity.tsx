...
const RecentActivity = () => {
  ...
  if (loading) {
    return (
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm overflow-hidden transition-colors duration-200">
        ...
        <div className="flex flex-col items-center justify-center p-12 sm:p-16 text-slate-600 dark:text-slate-400">
  ...
  if (error) {
    return (
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm overflow-hidden transition-colors duration-200">
        ...
        <div className="flex flex-col items-center justify-center p-12 sm:p-16 text-red-600 dark:text-red-400">
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm overflow-hidden transition-colors duration-200">
      <div className="p-4 md:p-6 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center gap-3 flex-wrap">
        ...
        <span className="bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 px-3 py-1 rounded-xl text-xs font-semibold whitespace-nowrap">
        ...
        {actividades.length > 0 ? (
          <div className="space-y-3">
            {actividades.map((actividad, index) => (
              <div key={`${actividad.tipo}-${index}`} className="flex gap-3 items-start p-3 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors duration-200">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm text-slate-800 dark:text-white font-medium leading-tight mb-1">

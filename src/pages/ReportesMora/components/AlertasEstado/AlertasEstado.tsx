...
const AlertasEstado: React.FC<AlertasEstadoProps> = ({
    ...
    return (
        <div className="fixed top-5 right-5 left-5 md:left-auto z-[9999] flex flex-col gap-3 max-w-md md:max-w-sm">
            {/* Mensaje de éxito */}
            {success && (
                <div className="flex items-center gap-3 px-4 py-3 bg-emerald-50 dark:bg-emerald-900/20 border-l-4 border-emerald-500 dark:border-emerald-600 rounded-lg shadow-lg animate-in slide-in-from-right duration-300">
            ...
            {/* Mensaje de error */}
            {error && (
                <div className="flex items-center gap-3 px-4 py-3 bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 dark:border-red-600 rounded-lg shadow-lg animate-in slide-in-from-right duration-300">
